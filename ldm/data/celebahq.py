...
class CelebAConditionalDataset(Dataset):
    ...
    def __init__(self,
        ...
        test_dataset_size=5,
        conditions = ['seg_mask'],
        image_folder = '/home/hyl/yujia/data_Description/train/images_512',
        # text_file = '/home/hyl/yujia/data_Description/train/images_256/metadata.json',
        text_file = '/home/hyl/yujia/add_data/translated_output.json',
        # text_file = '/home/hyl/yujia/test_data/v.json',
        mask_folder = '/home/hyl/yujia/data_5000_384/mask_tensor_num2_256',
