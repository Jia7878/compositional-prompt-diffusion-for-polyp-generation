...
def parse_args():
    ...
    parser.add_argument(
        "--input_text",
        type=str,
        default="The rectum is visible3.5cmLarge and small mushroom-shaped masses, with mucosal congestion and erosion at the edges, necrotic material attached to the central mucosa, and blood stains attached. Pathology showed adenocarcinoma and differentiation.IIclass.",
        help="text condition")
    ...
    parser.add_argument(
        "--ckpt_path",
        type=str,
        default="/home/hyl/yujia/conditional-polyp-diffusion/latent-diffusion/resume_sd/2024-02-26T09-36-23_stable-diffusion/checkpoints/only_text.ckpt",
...
def main():
    ...
    if args.enable_freeu:
        args.save_folder = f'{args.save_folder}_freeu_11_12_6_4'
    else:
